#bin/#!/bin/bash
	...
	git clone -q --depth=1 https://github.com/Tashar02/AnyKernel3.git $HOME/Repack
	git clone -q --depth=1 https://github.com/Atom-X-Devs/android_kernel_sdm660_tempest-4.19.git -b test-1 $HOME/Kernel
